...
public class MailJFrame extends JFrame {
	...
	public MailJFrame() {
		...
		tAbody.setText("A new auction, belongs to a category you are interested in has been added , please connect and check it out !");
		tAbody.setBounds(96, 138, 252, 104);
		panel.add(tAbody);
		
		tFsubject = new JTextField();
		tFsubject.setText("Notification about a new auction");
		...
		lblPassword.setBounds(10, 60, 78, 14);
		panel.add(lblPassword);
		
		passwordField = new JPasswordField();
		passwordField.setBounds(96, 59, 252, 20);
		...
		btnSend.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        mail.setMailAddressRecipient("bilel.khaled@esprit.tn");
