...
public class PanelShowOrder extends JPanel {
	...
	protected void initDataBindings() {
		...
		//
		BeanProperty<Order, Integer> orderBeanProperty_10 = BeanProperty.create("orderPK.idProduct");
		jTableBinding_1.addColumnBinding(orderBeanProperty_10).setColumnName("Product id");
		//
		...
		//
		BeanProperty<Order, Integer> orderBeanProperty_5 = BeanProperty.create("orderPK.idProduct");
		jTableBinding.addColumnBinding(orderBeanProperty_5).setColumnName("Product id");
		//
		BeanProperty<Order, Integer> orderBeanProperty_4 = BeanProperty.create("orderPK.idClient");
		jTableBinding.addColumnBinding(orderBeanProperty_4).setColumnName("Client id");
		//
		BeanProperty<Order, String> orderBeanProperty_1 = BeanProperty.create("adressClient");
		jTableBinding.addColumnBinding(orderBeanProperty_1).setColumnName("Adress");
		//
		...
		jTableBinding.addColumnBinding(orderBeanProperty).setColumnName("Payment Cash");
		//
		BeanProperty<Order, String> orderBeanProperty_2 = BeanProperty.create("state");
		jTableBinding.addColumnBinding(orderBeanProperty_2).setColumnName("State");
		//
		jTableBinding.bind();
	}
}
